...
var styleMap = map[string]WaypointStyle{
	...
	"Sanitation Dump Station": {"sanidump", "circle", "#800080"},
	"Hotel":                   {"hotel", "circle", "#0000ff"},
	"Hostel":                  {"hostel", "circle", "#0000ff"},
	"Restaurant":              {"restaurant", "circle", "#ff6600"},
	"Tourist Attraction":      {"tourism_viewpoint", "circle", "#ff00ff"},
	"Showers":                 {"shower", "circle", "#00ccff"},
	"Propane":                 {"gas_station", "circle", "#ffcc00"},
	"Medical":                 {"hospital", "circle", "#ff0000"},
	"Pet Services":            {"veterinary", "circle", "#996633"},
	"Financial":               {"bank", "circle", "#009900"},
	"Customs / Immigration":   {"border_control", "circle", "#ff0000"},
	"Checkpoint":              {"barrier", "circle", "#ff3300"},
	"Warning":                 {"warning", "circle", "#ff3300"},
	"Wifi":                    {"wifi", "circle", "#0099ff"},
	"Other":                   {"tourism_viewpoint", "circle", "#808080"},
}
